/*
 * SipServer_T_ETH_Lite_W5500 - Arduino Sketch for LilyGO T-ETH-Lite ESP32-S3
 *
 * Targets: LilyGO T-ETH-Lite ESP32-S3 (ESP32-S3 + W5500 via SPI)
 *          Board features: 16MB Flash, 8MB PSRAM, TF Card, PoE Shield support
 *
 ...
 *
 * IMPORTANT – Pin mapping (LilyGO T-ETH-Lite ESP32-S3):
 *   - SCLK: GPIO 10
 *   - MISO: GPIO 11
 *   - MOSI: GPIO 12
 *   - CS:   GPIO 9
...
static constexpr int W5500_MISO =  11;
static constexpr int W5500_MOSI =  12;
static constexpr int W5500_CS   =  9;
static constexpr int W5500_INT  =  13;
static constexpr int W5500_RST  =  14;
...
void setup()
{
    ...
    Serial.println();
    Serial.println("╔══════════════════════════════════════════╗");
    Serial.println("║  LILYGO T-ETH-Lite S3 W5500 SipServer    ║");
